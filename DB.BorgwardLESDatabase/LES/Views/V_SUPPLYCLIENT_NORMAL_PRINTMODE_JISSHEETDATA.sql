...
*******************************************************************/
CREATE VIEW [LES].[V_SUPPLYCLIENT_NORMAL_PRINTMODE_JISSHEETDATA]
AS
SELECT     Tj.JIS_RUNSHEET_SN, Tj.JIS_RUNSHEET_NO, Tj.JIS_RUNSHEET_TIME, Tj.PLANT, Tj.ASSEMBLY_LINE, Tr.RACK_CNAME AS rack_description, 
                      ...
                      Tj.BOOKKEEPER, Tj.REDO_FLAG, Tj.JIS_RUNSHEET_STATUS, Tj.SEND_STATUS, Tj.SEND_TIME, Tj.FAX_STATUS, Tj.FAX_TIME, Tj.SUPPLY_TIME, Tj.SAP_FLAG, 
                      ...
                      AS jis_runsheet_no2, Ts.SUPPLIER_NAME, Tr.RACK_CNAME, Tr.RACK_ROW, Tr.RACK_COLUMN, Tr.UNLOADBLDG, Tj.PLANT_ZONE
