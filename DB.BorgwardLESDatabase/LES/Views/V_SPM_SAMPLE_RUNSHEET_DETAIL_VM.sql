...
CREATE VIEW [LES].[V_SPM_SAMPLE_RUNSHEET_DETAIL_VM]
AS
...
FROM      LES.TT_SPM_SAMPLE_PURCHASE_RUNSHEET_DETAIL AS t_Detail INNER JOIN
                LES.TT_SPM_SAMPLE_PURCHASE_RUNSHEET AS t_RunSheet ON 
                t_RunSheet.PLAN_RUNSHEET_SN = t_Detail.PLAN_RUNSHEET_SN
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'LES', @level1type = N'VIEW', @level1name = N'V_SPM_SAMPLE_RUNSHEET_DETAIL_VM';
...
Begin DesignProperties = 
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'LES', @level1type = N'VIEW', @level1name = N'V_SPM_SAMPLE_RUNSHEET_DETAIL_VM';
