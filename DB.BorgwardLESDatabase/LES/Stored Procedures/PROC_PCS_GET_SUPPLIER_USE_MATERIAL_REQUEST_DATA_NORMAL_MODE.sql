...
CREATE PROCEDURE [LES].[PROC_PCS_GET_SUPPLIER_USE_MATERIAL_REQUEST_DATA_NORMAL_MODE]
(
	@TopCount		 int,
...
BEGIN
   ...
   WHERE supplier_num = '+ @SupplierNum +' and (send_status = ' + Convert(nvarchar(20),@SendStatus,20) + ' or send_status=5)
