...
$(function () {
    ...
    XR.ajaxCreateForm('SYS/UserList.html');//创建表单 --XR.reqPath:当前页面路径
    ...
    XR.ajaxCreateGrid('User', 480, false, false, false, true, 'Fid', 'Fid', 'desc');
...
function editrows(e) {
    ...
    XR.tAlert('pageIframe', '修改', 'UserEdit.html', 800, 480);
}
