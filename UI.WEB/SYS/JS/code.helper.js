...
$(function () {
    ...
    XR.ajaxCreateForm('SYS/CodeList.html');//创建表单 --XR.reqPath:当前页面路径
    ...
    XR.ajaxCreateGrid('Code', 480, false, false, false, true, 'Fid', 'Fid', 'desc');
...
function add() {
    XR.tAlert('pageIframe', '添加', 'SYS/CodeEdit.html', 800, 480);
}
...
function editrows(e) {
    ...
    XR.tAlert('pageIframe', '修改', 'CodeEdit.html', 800, 480);
}
