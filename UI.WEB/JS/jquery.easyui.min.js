...
(function ($) {
    ...
    //$.language = $.cookie('language') == null ? $.cookie('language', 'zh-cn', { expires: 7 }) : $.cookie('language');//navigator.browserLanguage.toLowerCase();取浏览器语言版本
...
(function ($) {
    ...
    $.messager = {
        show: function (_2b5) {
            ...
            return dlg;
        }, msgloading: function (_2b9) {
            var _2ba = {
                close: function () {
                    var dlg = $("body>div.messager-window>div.messager-body:has(div.messager-msloading)");
                    if (dlg.length) {
                        dlg.dialog("close");
                    }
                }
            ...
            _2b9 = _2b9 || {};
            var opts = $.extend({}, { title: "", minHeight: 0, content: undefined, width: 360, heigth: 100 }, _2b9);
            var dlg = _2b2($.extend({}, $.messager.defaults, { content: "<div class=\"messager-msloading\"><img class=\"messager-img-loading\" src=\"JS/themes/default/images/loadingblue.gif\"></img></div>", closable: false, doSize: false }, opts, {
                onClose: function () {
                    if (this.timer) {
                        clearInterval(this.timer);
                    }
...
(function ($) {
    ...
    function _8b7(_8da, _8db) {
        ...
        //if (row._parentId) LXR.2016.5.31
        if (row != null && row._parentId) {
    ...
    cascadeCheck: function (target, param) {
        ...
        function selectChildren(target, id, idField, deepCascade, status) {
            ...
            for (var i = 0; i < children.length; i++) {
                ...
                var childrenId = children[i][idField];
                if (status)
                    $(target).treegrid('select', childrenId);
                else
                    $(target).treegrid('unselect', childrenId);
                selectChildren(target, childrenId, idField, deepCascade, status);
            }
        }
    }
});
