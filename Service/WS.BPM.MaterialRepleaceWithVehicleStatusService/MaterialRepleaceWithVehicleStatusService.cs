...
{
    public partial class MaterialRepleaceWithVehicleStatusService : ServiceBase
    {
        private Guid serviceFid;
        MaterialRepleaceWithVehicleStatusThread thread;
        public MaterialRepleaceWithVehicleStatusService(Guid serviceFid)
        {
        ...
        protected override void OnStart(string[] args)
        {
            ...
            {
                if (thread == null)
                    thread = new MaterialRepleaceWithVehicleStatusThread(serviceFid);
                thread.Start();
            }
            catch (Exception ex)
            {
