...
namespace BLL.LES
{
    public class InventoryOrderPartPageBLL
    {
        #region Common
        ...
        {
            textWhere += "and [ORDER_FID] in (select [FID] from [LES].[TT_WMM_INVENTORY_NOTICE_ORDER] where STATUS = " + (int)InventoryOrderStatusConstants.COMPLETED + ")";
