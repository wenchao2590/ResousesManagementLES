namespace BLL.LES
{
    ...
    public partial class BusinessExpenseInPageBLL
    {
        #region Common
        ...
        {
            return new BusinessExpenseInBLL().LogicDeleteInfo(id, loginUser);
        }
        /// <summary>
        /// UpdateInfo
        /// </summary>
        ...
        {
            return new BusinessExpenseInBLL().UpdateInfo(fields, id);
        }
        #endregion
