...
namespace BLL.LES
{
    public class SapPurchaseOrderDetailBLL
    {
        #region Common
        ...
        /// <param name="textOrder">string 排序语句,无须order by</param>
        /// <returns>List<SapPurchaseOrderDetailInfo></returns>
        public List<SapPurchaseOrderDetailInfo> GetList(string textWhere, string textOrder)
        {
        ...
        {
            return dal.GetInfo(orderCode, partNo);
        }
    }
}
