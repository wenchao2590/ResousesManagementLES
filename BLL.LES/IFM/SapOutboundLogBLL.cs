namespace BLL.LES
{
    ...
    /// SapOutboundLogBLL
    /// </summary>
    public class SapOutboundLogBLL
    {
        #region Common
        /// <summary>
        /// SapOutboundLogDAL
        /// </summary>
        SapOutboundLogDAL dal = new SapOutboundLogDAL();
        /// <summary>
        /// GetListByPage
        /// </summary>
        ...
        /// <returns></returns>
        public List<SapOutboundLogInfo> GetListByPage(string textWhere, string textOrder, int pageIndex, int pageRow, out int dataCount)
        {
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public SapOutboundLogInfo SelectInfo(long id)
        {
        ...
        public bool ResendInfos(List<string> rowsKeyValues, string loginUser)
        {
            ...
            {
                @string.AppendLine(CommonBLL.GetUpdateResultLogSql("SAP", Convert.ToInt64(rowsKeyValue), ExecuteResultConstants.Resend, string.Empty, string.Empty, string.Empty, loginUser));
            }
        ...
        public bool CancelInfos(List<string> rowsKeyValues, string loginUser)
        {
            ...
            foreach (var rowsKeyValue in rowsKeyValues)
            {
                @string.AppendLine(CommonBLL.GetUpdateResultLogSql("SAP", Convert.ToInt64(rowsKeyValue), ExecuteResultConstants.Cancel, string.Empty, string.Empty, string.Empty, loginUser));
            }
            using (var trans = new TransactionScope())
            {
                if (@string.Length > 0)
        ...
        /// </summary>
        /// <returns></returns>
        public List<SapOutboundLogInfo> GetListForUnsend()
        {
