namespace BLL.LES
{
    ...
    /// SrmOutboundLogBLL
    /// </summary>
    public partial class SrmOutboundLogBLL
    {
        #region Common
        /// <summary>
        /// SrmOutboundLogDAL
        /// </summary>
        SrmOutboundLogDAL dal = new SrmOutboundLogDAL();
        /// <summary>
        /// GetListByPage
        /// </summary>
        ...
        /// <returns></returns>
        public List<SrmOutboundLogInfo> GetListByPage(string textWhere, string textOrder, int pageIndex, int pageRow, out int dataCount)
        {
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public SrmOutboundLogInfo SelectInfo(long id)
        {
        ...
        public bool ResendInfos(List<string> rowsKeyValues, string loginUser)
        {
            ...
            {
                @string.AppendLine(CommonBLL.GetUpdateResultLogSql("SRM", Convert.ToInt64(rowsKeyValue), ExecuteResultConstants.Resend, string.Empty, string.Empty, string.Empty, loginUser));
            }
        ...
        public bool CancelInfos(List<string> rowsKeyValues, string loginUser)
        {
            ...
            foreach (var rowsKeyValue in rowsKeyValues)
            {
                @string.AppendLine(CommonBLL.GetUpdateResultLogSql("SRM", Convert.ToInt64(rowsKeyValue), ExecuteResultConstants.Cancel, string.Empty, string.Empty, string.Empty, loginUser));
            }
            using (var trans = new TransactionScope())
            {
                if (@string.Length > 0)
        ...
        /// </summary>
        /// <returns></returns>
        public List<SrmOutboundLogInfo> GetListForUnsend()
        {
