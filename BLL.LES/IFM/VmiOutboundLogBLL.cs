namespace BLL.LES
{
    ...
    /// VmiOutboundLogBLL
    /// </summary>
    public class VmiOutboundLogBLL
    {
        #region Common
        /// <summary>
        /// VmiOutboundLogDAL
        /// </summary>
        VmiOutboundLogDAL dal = new VmiOutboundLogDAL();
        /// <summary>
        /// GetListByPage
        /// </summary>
        ...
        /// <returns></returns>
        public List<VmiOutboundLogInfo> GetListByPage(string textWhere, string textOrder, int pageIndex, int pageRow, out int dataCount)
        {
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public VmiOutboundLogInfo SelectInfo(long id)
        {
        ...
        public bool ResendInfos(List<string> rowsKeyValues, string loginUser)
        {
            ...
            {
                @string.AppendLine(CommonBLL.GetUpdateResultLogSql("VMI", Convert.ToInt64(rowsKeyValue), ExecuteResultConstants.Resend, string.Empty, string.Empty, string.Empty, loginUser));
            }
