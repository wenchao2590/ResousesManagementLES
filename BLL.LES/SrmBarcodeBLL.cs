...
namespace BLL.LES
{
    public class SrmBarcodeBLL
    {
        #region Common
        SrmBarcodeDAL dal = new SrmBarcodeDAL();
        /// <summary>
        /// 分页获取集合
        /// </summary>
        ...
        /// <returns>List<SrmBarcodeInfo></returns>
        public List<SrmBarcodeInfo> GetListByPage(string textWhere, string textOrder, int pageIndex, int pageRow, out int dataCount)
        {
		...
		/// <returns>SrmBarcodeInfo Collection </returns>
		public List<SrmBarcodeInfo> GetList(string textWhere, string orderText)
        {

            return dal.GetList(textWhere, orderText);
        }
        public SrmBarcodeInfo SelectInfo(long id)
        {
            return dal.GetInfo(id);
        }

        public long InsertInfo(SrmBarcodeInfo info)
        {
            return dal.Add(info);
        }
