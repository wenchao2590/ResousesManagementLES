...
namespace BLL.LES
{
    public class VmiJisPullOrderDetailsBLL
    {
        #region Common
		...
		/// <returns>WmsVmiJisPullOrderDetailInfo Collection </returns>
		public List<WmsVmiJisPullOrderDetailInfo> GetList(string textWhere, string orderText)
        {
