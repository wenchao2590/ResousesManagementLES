...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'派发延迟时间(分钟)', @level0type = N'SCHEMA', @level0name = N'LES', @level1type = N'TABLE', @level1name = N'TM_BAS_ONBOARD_TASK_GROUP', @level2type = N'COLUMN', @level2name = N'DELAY_TIME';
