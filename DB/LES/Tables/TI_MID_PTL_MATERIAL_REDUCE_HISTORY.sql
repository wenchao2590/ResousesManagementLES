...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'创建时间', @level0type = N'SCHEMA', @level0name = N'LES', @level1type = N'TABLE', @level1name = N'TI_MID_PTL_MATERIAL_REDUCE_HISTORY', @level2type = N'COLUMN', @level2name = N'CreateTime';
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'VIN', @level0type = N'SCHEMA', @level0name = N'LES', @level1type = N'TABLE', @level1name = N'TI_MID_PTL_MATERIAL_REDUCE_HISTORY', @level2type = N'COLUMN', @level2name = N'VIN';
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'订单号', @level0type = N'SCHEMA', @level0name = N'LES', @level1type = N'TABLE', @level1name = N'TI_MID_PTL_MATERIAL_REDUCE_HISTORY', @level2type = N'COLUMN', @level2name = N'OrderNo';
