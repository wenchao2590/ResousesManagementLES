...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'端口号', @level0type = N'SCHEMA', @level0name = N'LES', @level1type = N'TABLE', @level1name = N'TM_BAS_ONBOARD_EQUIPMENT', @level2type = N'COLUMN', @level2name = N'RFID_PORT';


GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'RFID_IP', @level0type = N'SCHEMA', @level0name = N'LES', @level1type = N'TABLE', @level1name = N'TM_BAS_ONBOARD_EQUIPMENT', @level2type = N'COLUMN', @level2name = N'RFID_IP';
