...
namespace BLL.BAS
{
    public class StzldBLL
    {
        #region Common
        StzldDAL dal = new StzldDAL();
        public List<StzldInfo> GetListByPage(string textWhere, string textOrder, int pageIndex, int pageRow, out int dataCount)
        {
            dataCount = dal.GetCounts(textWhere);
            return dal.GetListByPage(textWhere, textOrder, pageIndex, pageRow);
        }

        public StzldInfo SelectInfo(int nid)
        {
