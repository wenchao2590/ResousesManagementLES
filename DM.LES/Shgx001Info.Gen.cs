...
//---------------------------------------------------------------------------
// Name:		Shgx001Info
// Function: 	Expose data in table Shgx001 from database as business object to MES system.
// Tool:		T4
...
{   
	/// <summary>
    /// Shgx001Info对应表[V_WMM_SHGX_001]
    /// </summary>	
	[Serializable] 
	[DataContract]	
    public partial class Shgx001Info : BusinessObject, ICloneable 
	{		  
		#region Constructors
		...
		public Shgx001Info():base("V_WMM_SHGX_001")
		{
		...
		public Shgx001Info Clone()
		{
			return ((ICloneable) this).Clone() as Shgx001Info;	
		}
		#endregion
	...
	/// <summary>
    /// Shgx001InfoCollection对应表[V_WMM_SHGX_001]
    /// </summary>
	public partial class Shgx001InfoCollection : BusinessObjectCollection<Shgx001Info>
	{
		public Shgx001InfoCollection():base("V_WMM_SHGX_001"){}	
	}
}
