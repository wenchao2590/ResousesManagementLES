#region Declaim
//---------------------------------------------------------------------------
// Name:		QmisOutboundLogInfo
// Function: 	Expose data in table QmisOutboundLog from database as business object to MES system.
// Tool:		T4
...
{   
	/// <summary>
    /// QmisOutboundLogInfo对应表[TI_IFM_QMIS_OUTBOUND_LOG]
    /// </summary>	
	[Serializable] 
	[DataContract]	
    public partial class QmisOutboundLogInfo : BusinessObject, ICloneable 
	{		  
		#region Constructors
		
		public QmisOutboundLogInfo( 
					long aId,
		...
		public QmisOutboundLogInfo():base("TI_IFM_QMIS_OUTBOUND_LOG")
		{
		...
		public QmisOutboundLogInfo Clone()
		{
			return ((ICloneable) this).Clone() as QmisOutboundLogInfo;	
		}
		#endregion
	...
	/// <summary>
    /// QmisOutboundLogInfoCollection对应表[TI_IFM_QMIS_OUTBOUND_LOG]
    /// </summary>
	public partial class QmisOutboundLogInfoCollection : BusinessObjectCollection<QmisOutboundLogInfo>
	{
		public QmisOutboundLogInfoCollection():base("TI_IFM_QMIS_OUTBOUND_LOG"){}	
	}
}
