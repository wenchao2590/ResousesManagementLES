#region Declaim
//---------------------------------------------------------------------------
// Name:		SmsOutboundDetailLogInfo
// Function: 	Expose data in table SmsOutboundDetailLog from database as business object to MES system.
// Tool:		T4
...
{   
	/// <summary>
    /// SmsOutboundDetailLogInfo对应表[TI_IFM_SMS_OUTBOUND_DETAIL_LOG]
    /// </summary>	
	[Serializable] 
	[DataContract]	
    public partial class SmsOutboundDetailLogInfo : BusinessObject, ICloneable 
	{		  
		#region Constructors
		
		public SmsOutboundDetailLogInfo( 
					int aId,
		...
		public SmsOutboundDetailLogInfo():base("TI_IFM_SMS_OUTBOUND_DETAIL_LOG")
		{
		...
		public SmsOutboundDetailLogInfo Clone()
		{
			return ((ICloneable) this).Clone() as SmsOutboundDetailLogInfo;	
		}
		#endregion
	...
	/// <summary>
    /// SmsOutboundDetailLogInfoCollection对应表[TI_IFM_SMS_OUTBOUND_DETAIL_LOG]
    /// </summary>
	public partial class SmsOutboundDetailLogInfoCollection : BusinessObjectCollection<SmsOutboundDetailLogInfo>
	{
		public SmsOutboundDetailLogInfoCollection():base("TI_IFM_SMS_OUTBOUND_DETAIL_LOG"){}	
	}
}
