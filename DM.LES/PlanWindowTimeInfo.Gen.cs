#region Declaim
//---------------------------------------------------------------------------
// Name:		PlanWindowTimeInfo
// Function: 	Expose data in table PlanWindowTime from database as business object to MES system.
// Tool:		T4
...
{   
	/// <summary>
    /// PlanWindowTimeInfo对应表[TT_MPM_PLAN_WINDOW_TIME]
    /// </summary>	
	[Serializable] 
	[DataContract]	
    public partial class PlanWindowTimeInfo : BusinessObject, ICloneable 
	{		  
		#region Constructors
		
		public PlanWindowTimeInfo( 
					long aId,
		...
		public PlanWindowTimeInfo Clone()
		{
			return ((ICloneable) this).Clone() as PlanWindowTimeInfo;	
		}
		#endregion
	...
	/// <summary>
    /// PlanWindowTimeInfoCollection对应表[TT_MPM_PLAN_WINDOW_TIME]
    /// </summary>
	public partial class PlanWindowTimeInfoCollection : BusinessObjectCollection<PlanWindowTimeInfo>
	{
		public PlanWindowTimeInfoCollection():base("TT_MPM_PLAN_WINDOW_TIME"){}	
	}
}
