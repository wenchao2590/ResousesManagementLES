#region Declaim
//---------------------------------------------------------------------------
// Name:		SrmInboundLogInfo
// Function: 	Expose data in table SrmInboundLog from database as business object to MES system.
// Tool:		T4
...
{   
	/// <summary>
    /// SrmInboundLogInfo对应表[TI_IFM_SRM_INBOUND_LOG]
    /// </summary>	
	[Serializable] 
	[DataContract]	
    public partial class SrmInboundLogInfo : BusinessObject, ICloneable 
	{		  
		#region Constructors
		
		public SrmInboundLogInfo( 
					long aId,
		...
		public SrmInboundLogInfo():base("TI_IFM_SRM_INBOUND_LOG")
		{
		...
		public SrmInboundLogInfo Clone()
		{
			return ((ICloneable) this).Clone() as SrmInboundLogInfo;	
		}
		#endregion
	...
	/// <summary>
    /// SrmInboundLogInfoCollection对应表[TI_IFM_SRM_INBOUND_LOG]
    /// </summary>
	public partial class SrmInboundLogInfoCollection : BusinessObjectCollection<SrmInboundLogInfo>
	{
		public SrmInboundLogInfoCollection():base("TI_IFM_SRM_INBOUND_LOG"){}	
	}
}
