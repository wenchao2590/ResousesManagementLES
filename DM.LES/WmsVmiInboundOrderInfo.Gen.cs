#region Declaim
//---------------------------------------------------------------------------
// Name:		WmsVmiInboundOrderInfo
// Function: 	Expose data in table WmsVmiInboundOrder from database as business object to MES system.
// Tool:		T4
...
{   
	/// <summary>
    /// WmsVmiInboundOrderInfo对应表[TI_IFM_WMS_VMI_INBOUND_ORDER]
    /// </summary>	
	[Serializable] 
	[DataContract]	
    public partial class WmsVmiInboundOrderInfo : BusinessObject, ICloneable 
	{		  
		#region Constructors
		
		public WmsVmiInboundOrderInfo( 
					long aId,
		...
		public WmsVmiInboundOrderInfo():base("TI_IFM_WMS_VMI_INBOUND_ORDER")
		{
			...
			DataSchemaField PART_DETAILSField = new DataSchemaField();
			PART_DETAILSField.Name = "PART_DETAILS";
			PART_DETAILSField.Type = typeof(string).ToString();
			PART_DETAILSField.Index = 10;
			fields.Add(PART_DETAILSField);
		...
		public WmsVmiInboundOrderInfo Clone()
		{
			return ((ICloneable) this).Clone() as WmsVmiInboundOrderInfo;	
		}
		#endregion
	...
	/// <summary>
    /// WmsVmiInboundOrderInfoCollection对应表[TI_IFM_WMS_VMI_INBOUND_ORDER]
    /// </summary>
	public partial class WmsVmiInboundOrderInfoCollection : BusinessObjectCollection<WmsVmiInboundOrderInfo>
	{
		public WmsVmiInboundOrderInfoCollection():base("TI_IFM_WMS_VMI_INBOUND_ORDER"){}	
	}
}
