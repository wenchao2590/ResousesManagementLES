#region Declaim
//---------------------------------------------------------------------------
// Name:		MesInformationPointBasicInfo
// Function: 	Expose data in table MesInformationPointBasic from database as business object to MES system.
// Tool:		T4
...
{   
	/// <summary>
    /// MesInformationPointBasicInfo对应表[TI_IFM_MES_INFORMATION_POINT_BASIC]
    /// </summary>	
	[Serializable] 
	[DataContract]	
    public partial class MesInformationPointBasicInfo : BusinessObject, ICloneable 
	{		  
		#region Constructors
		
		public MesInformationPointBasicInfo( 
					long aId,
		...
		public MesInformationPointBasicInfo():base("TI_IFM_MES_INFORMATION_POINT_BASIC")
		{
		...
		public MesInformationPointBasicInfo Clone()
		{
			return ((ICloneable) this).Clone() as MesInformationPointBasicInfo;	
		}
		#endregion
	...
	/// <summary>
    /// MesInformationPointBasicInfoCollection对应表[TI_IFM_MES_INFORMATION_POINT_BASIC]
    /// </summary>
	public partial class MesInformationPointBasicInfoCollection : BusinessObjectCollection<MesInformationPointBasicInfo>
	{
		public MesInformationPointBasicInfoCollection():base("TI_IFM_MES_INFORMATION_POINT_BASIC"){}	
	}
}
