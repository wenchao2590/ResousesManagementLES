#region Declaim
//---------------------------------------------------------------------------
// Name:		WmsVmiAsnRunsheetInfo
// Function: 	Expose data in table WmsVmiAsnRunsheet from database as business object to MES system.
// Tool:		T4
...
{   
	/// <summary>
    /// WmsVmiAsnRunsheetInfo对应表[TI_IFM_WMS_VMI_ASN_RUNSHEET]
    /// </summary>	
	[Serializable] 
	[DataContract]	
    public partial class WmsVmiAsnRunsheetInfo : BusinessObject, ICloneable 
	{		  
		#region Constructors
		
		public WmsVmiAsnRunsheetInfo( 
					long aId,
		...
		public WmsVmiAsnRunsheetInfo():base("TI_IFM_WMS_VMI_ASN_RUNSHEET")
		{
		...
		public WmsVmiAsnRunsheetInfo Clone()
		{
			return ((ICloneable) this).Clone() as WmsVmiAsnRunsheetInfo;	
		}
		#endregion
	...
	/// <summary>
    /// WmsVmiAsnRunsheetInfoCollection对应表[TI_IFM_WMS_VMI_ASN_RUNSHEET]
    /// </summary>
	public partial class WmsVmiAsnRunsheetInfoCollection : BusinessObjectCollection<WmsVmiAsnRunsheetInfo>
	{
		public WmsVmiAsnRunsheetInfoCollection():base("TI_IFM_WMS_VMI_ASN_RUNSHEET"){}	
	}
}
