#region Declaim
//---------------------------------------------------------------------------
// Name:		SrmSupplyPlanInfo
// Function: 	Expose data in table SrmSupplyPlan from database as business object to MES system.
// Tool:		T4
...
{   
	/// <summary>
    /// SrmSupplyPlanInfo对应表[TI_IFM_SRM_SUPPLY_PLAN]
    /// </summary>	
	[Serializable] 
	[DataContract]	
    public partial class SrmSupplyPlanInfo : BusinessObject, ICloneable 
	{		  
		#region Constructors
		
		public SrmSupplyPlanInfo( 
					long aId,
		...
		public SrmSupplyPlanInfo():base("TI_IFM_SRM_SUPPLY_PLAN")
		{
		...
		public SrmSupplyPlanInfo Clone()
		{
			return ((ICloneable) this).Clone() as SrmSupplyPlanInfo;	
		}
		#endregion
	...
	/// <summary>
    /// SrmSupplyPlanInfoCollection对应表[TI_IFM_SRM_SUPPLY_PLAN]
    /// </summary>
	public partial class SrmSupplyPlanInfoCollection : BusinessObjectCollection<SrmSupplyPlanInfo>
	{
		public SrmSupplyPlanInfoCollection():base("TI_IFM_SRM_SUPPLY_PLAN"){}	
	}
}
