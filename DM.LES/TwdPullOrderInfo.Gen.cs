#region Declaim
//---------------------------------------------------------------------------
// Name:		TwdPullOrderInfo
// Function: 	Expose data in table TwdPullOrder from database as business object to MES system.
// Tool:		T4
...
{   
	/// <summary>
    /// TwdPullOrderInfo对应表[TT_MPM_TWD_PULL_ORDER]
    /// </summary>	
	[Serializable] 
	[DataContract]	
    public partial class TwdPullOrderInfo : BusinessObject, ICloneable 
	{		  
		#region Constructors
		
		public TwdPullOrderInfo( 
					long aId,
		...
		public TwdPullOrderInfo():base("TT_MPM_TWD_PULL_ORDER")
		{
		...
		public TwdPullOrderInfo Clone()
		{
			return ((ICloneable) this).Clone() as TwdPullOrderInfo;	
		}
		#endregion
	...
	/// <summary>
    /// TwdPullOrderInfoCollection对应表[TT_MPM_TWD_PULL_ORDER]
    /// </summary>
	public partial class TwdPullOrderInfoCollection : BusinessObjectCollection<TwdPullOrderInfo>
	{
		public TwdPullOrderInfoCollection():base("TT_MPM_TWD_PULL_ORDER"){}	
	}
}
