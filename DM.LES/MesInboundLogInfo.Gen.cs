#region Declaim
//---------------------------------------------------------------------------
// Name:		MesInboundLogInfo
// Function: 	Expose data in table MesInboundLog from database as business object to MES system.
// Tool:		T4
...
{   
	/// <summary>
    /// MesInboundLogInfo对应表[TI_IFM_MES_INBOUND_LOG]
    /// </summary>	
	[Serializable] 
	[DataContract]	
    public partial class MesInboundLogInfo : BusinessObject, ICloneable 
	{		  
		#region Constructors
		
		public MesInboundLogInfo( 
					long aId,
		...
		public MesInboundLogInfo Clone()
		{
			return ((ICloneable) this).Clone() as MesInboundLogInfo;	
		}
		#endregion
	...
	/// <summary>
    /// MesInboundLogInfoCollection对应表[TI_IFM_MES_INBOUND_LOG]
    /// </summary>
	public partial class MesInboundLogInfoCollection : BusinessObjectCollection<MesInboundLogInfo>
	{
		public MesInboundLogInfoCollection():base("TI_IFM_MES_INBOUND_LOG"){}	
	}
}
