#region Declaim
//---------------------------------------------------------------------------
// Name:		SapOutboundLogInfo
// Function: 	Expose data in table SapOutboundLog from database as business object to MES system.
// Tool:		T4
...
{   
	/// <summary>
    /// SapOutboundLogInfo对应表[TI_IFM_SAP_OUTBOUND_LOG]
    /// </summary>	
	[Serializable] 
	[DataContract]	
    public partial class SapOutboundLogInfo : BusinessObject, ICloneable 
	{		  
		#region Constructors
		
		public SapOutboundLogInfo( 
					long aId,
		...
		public SapOutboundLogInfo():base("TI_IFM_SAP_OUTBOUND_LOG")
		{
		...
		public SapOutboundLogInfo Clone()
		{
			return ((ICloneable) this).Clone() as SapOutboundLogInfo;	
		}
		#endregion
	...
	/// <summary>
    /// SapOutboundLogInfoCollection对应表[TI_IFM_SAP_OUTBOUND_LOG]
    /// </summary>
	public partial class SapOutboundLogInfoCollection : BusinessObjectCollection<SapOutboundLogInfo>
	{
		public SapOutboundLogInfoCollection():base("TI_IFM_SAP_OUTBOUND_LOG"){}	
	}
}
