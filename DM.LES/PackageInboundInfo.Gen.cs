#region Declaim
//---------------------------------------------------------------------------
// Name:		PackageInboundInfo
// Function: 	Expose data in table PackageInbound from database as business object to MES system.
// Tool:		T4
...
{   
	/// <summary>
    /// PackageInboundInfo对应表[TT_PCM_PACKAGE_INBOUND]
    /// </summary>	
	[Serializable] 
	[DataContract]	
    public partial class PackageInboundInfo : BusinessObject, ICloneable 
	{		  
		#region Constructors
		
		public PackageInboundInfo( 
					long aId,
		...
		public PackageInboundInfo():base("TT_PCM_PACKAGE_INBOUND")
		{
		...
		public PackageInboundInfo Clone()
		{
			return ((ICloneable) this).Clone() as PackageInboundInfo;	
		}
		#endregion
	...
	/// <summary>
    /// PackageInboundInfoCollection对应表[TT_PCM_PACKAGE_INBOUND]
    /// </summary>
	public partial class PackageInboundInfoCollection : BusinessObjectCollection<PackageInboundInfo>
	{
		public PackageInboundInfoCollection():base("TT_PCM_PACKAGE_INBOUND"){}	
	}
}
