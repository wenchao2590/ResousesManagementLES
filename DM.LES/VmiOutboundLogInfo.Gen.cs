#region Declaim
//---------------------------------------------------------------------------
// Name:		VmiOutboundLogInfo
// Function: 	Expose data in table VmiOutboundLog from database as business object to MES system.
// Tool:		T4
...
{   
	/// <summary>
    /// VmiOutboundLogInfo对应表[TI_IFM_VMI_OUTBOUND_LOG]
    /// </summary>	
	[Serializable] 
	[DataContract]	
    public partial class VmiOutboundLogInfo : BusinessObject, ICloneable 
	{		  
		#region Constructors
		
		public VmiOutboundLogInfo( 
					long aId,
		...
		public VmiOutboundLogInfo():base("TI_IFM_VMI_OUTBOUND_LOG")
		{
		...
		public VmiOutboundLogInfo Clone()
		{
			return ((ICloneable) this).Clone() as VmiOutboundLogInfo;	
		}
		#endregion
	...
	/// <summary>
    /// VmiOutboundLogInfoCollection对应表[TI_IFM_VMI_OUTBOUND_LOG]
    /// </summary>
	public partial class VmiOutboundLogInfoCollection : BusinessObjectCollection<VmiOutboundLogInfo>
	{
		public VmiOutboundLogInfoCollection():base("TI_IFM_VMI_OUTBOUND_LOG"){}	
	}
}
