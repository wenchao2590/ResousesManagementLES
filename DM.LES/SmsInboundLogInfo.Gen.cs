#region Declaim
//---------------------------------------------------------------------------
// Name:		SmsInboundLogInfo
// Function: 	Expose data in table SmsInboundLog from database as business object to MES system.
// Tool:		T4
...
{   
	/// <summary>
    /// SmsInboundLogInfo对应表[TI_IFM_SMS_INBOUND_LOG]
    /// </summary>	
	[Serializable] 
	[DataContract]	
    public partial class SmsInboundLogInfo : BusinessObject, ICloneable 
	{		  
		#region Constructors
		
		public SmsInboundLogInfo( 
					long aId,
		...
		public SmsInboundLogInfo():base("TI_IFM_SMS_INBOUND_LOG")
		{
		...
		public SmsInboundLogInfo Clone()
		{
			return ((ICloneable) this).Clone() as SmsInboundLogInfo;	
		}
		#endregion
	...
	/// <summary>
    /// SmsInboundLogInfoCollection对应表[TI_IFM_SMS_INBOUND_LOG]
    /// </summary>
	public partial class SmsInboundLogInfoCollection : BusinessObjectCollection<SmsInboundLogInfo>
	{
		public SmsInboundLogInfoCollection():base("TI_IFM_SMS_INBOUND_LOG"){}	
	}
}
