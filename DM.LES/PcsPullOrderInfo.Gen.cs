#region Declaim
//---------------------------------------------------------------------------
// Name:		PcsPullOrderInfo
// Function: 	Expose data in table PcsPullOrder from database as business object to MES system.
// Tool:		T4
...
{   
	/// <summary>
    /// PcsPullOrderInfo对应表[TT_MPM_PCS_PULL_ORDER]
    /// </summary>	
	[Serializable] 
	[DataContract]	
    public partial class PcsPullOrderInfo : BusinessObject, ICloneable 
	{		  
		#region Constructors
		
		public PcsPullOrderInfo( 
					long aId,
		...
		public PcsPullOrderInfo():base("TT_MPM_PCS_PULL_ORDER")
		{
		...
		public PcsPullOrderInfo Clone()
		{
			return ((ICloneable) this).Clone() as PcsPullOrderInfo;	
		}
		#endregion
	...
	/// <summary>
    /// PcsPullOrderInfoCollection对应表[TT_MPM_PCS_PULL_ORDER]
    /// </summary>
	public partial class PcsPullOrderInfoCollection : BusinessObjectCollection<PcsPullOrderInfo>
	{
		public PcsPullOrderInfoCollection():base("TT_MPM_PCS_PULL_ORDER"){}	
	}
}
