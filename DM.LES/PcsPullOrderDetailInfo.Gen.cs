#region Declaim
//---------------------------------------------------------------------------
// Name:		PcsPullOrderDetailInfo
// Function: 	Expose data in table PcsPullOrderDetail from database as business object to MES system.
// Tool:		T4
...
{   
	/// <summary>
    /// PcsPullOrderDetailInfo对应表[TT_MPM_PCS_PULL_ORDER_DETAIL]
    /// </summary>	
	[Serializable] 
	[DataContract]	
    public partial class PcsPullOrderDetailInfo : BusinessObject, ICloneable 
	{		  
		#region Constructors
		
		public PcsPullOrderDetailInfo( 
					long aId,
		...
		public PcsPullOrderDetailInfo():base("TT_MPM_PCS_PULL_ORDER_DETAIL")
		{
		...
		public PcsPullOrderDetailInfo Clone()
		{
			return ((ICloneable) this).Clone() as PcsPullOrderDetailInfo;	
		}
		#endregion
	...
	/// <summary>
    /// PcsPullOrderDetailInfoCollection对应表[TT_MPM_PCS_PULL_ORDER_DETAIL]
    /// </summary>
	public partial class PcsPullOrderDetailInfoCollection : BusinessObjectCollection<PcsPullOrderDetailInfo>
	{
		public PcsPullOrderDetailInfoCollection():base("TT_MPM_PCS_PULL_ORDER_DETAIL"){}	
	}
}
