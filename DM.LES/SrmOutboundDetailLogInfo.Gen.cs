#region Declaim
//---------------------------------------------------------------------------
// Name:		SrmOutboundDetailLogInfo
// Function: 	Expose data in table SrmOutboundDetailLog from database as business object to MES system.
// Tool:		T4
...
{   
	/// <summary>
    /// SrmOutboundDetailLogInfo对应表[TI_IFM_SRM_OUTBOUND_DETAIL_LOG]
    /// </summary>	
	[Serializable] 
	[DataContract]	
    public partial class SrmOutboundDetailLogInfo : BusinessObject, ICloneable 
	{		  
		#region Constructors
		
		public SrmOutboundDetailLogInfo( 
					int aId,
		...
		public SrmOutboundDetailLogInfo():base("TI_IFM_SRM_OUTBOUND_DETAIL_LOG")
		{
		...
		public SrmOutboundDetailLogInfo Clone()
		{
			return ((ICloneable) this).Clone() as SrmOutboundDetailLogInfo;	
		}
		#endregion
	...
	/// <summary>
    /// SrmOutboundDetailLogInfoCollection对应表[TI_IFM_SRM_OUTBOUND_DETAIL_LOG]
    /// </summary>
	public partial class SrmOutboundDetailLogInfoCollection : BusinessObjectCollection<SrmOutboundDetailLogInfo>
	{
		public SrmOutboundDetailLogInfoCollection():base("TI_IFM_SRM_OUTBOUND_DETAIL_LOG"){}	
	}
}
