#region Declaim
//---------------------------------------------------------------------------
// Name:		VmiInboundLogInfo
// Function: 	Expose data in table VmiInboundLog from database as business object to MES system.
// Tool:		T4
...
{   
	/// <summary>
    /// VmiInboundLogInfo对应表[TI_IFM_VMI_INBOUND_LOG]
    /// </summary>	
	[Serializable] 
	[DataContract]	
    public partial class VmiInboundLogInfo : BusinessObject, ICloneable 
	{		  
		#region Constructors
		
		public VmiInboundLogInfo( 
					long aId,
		...
		public VmiInboundLogInfo():base("TI_IFM_VMI_INBOUND_LOG")
		{
		...
		public VmiInboundLogInfo Clone()
		{
			return ((ICloneable) this).Clone() as VmiInboundLogInfo;	
		}
		#endregion
	...
	/// <summary>
    /// VmiInboundLogInfoCollection对应表[TI_IFM_VMI_INBOUND_LOG]
    /// </summary>
	public partial class VmiInboundLogInfoCollection : BusinessObjectCollection<VmiInboundLogInfo>
	{
		public VmiInboundLogInfoCollection():base("TI_IFM_VMI_INBOUND_LOG"){}	
	}
}
