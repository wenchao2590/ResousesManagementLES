#region Declaim
//---------------------------------------------------------------------------
// Name:		VmiTransDetailInfo
// Function: 	Expose data in table VmiTransDetail from database as business object to MES system.
// Tool:		T4
...
{   
	/// <summary>
    /// VmiTransDetailInfo对应表[TT_WMM_VMI_TRANS_DETAIL]
    /// </summary>	
	[Serializable] 
	[DataContract]	
    public partial class VmiTransDetailInfo : BusinessObject, ICloneable 
	{		  
		#region Constructors
		
		public VmiTransDetailInfo( 
					long aId,
		...
		public VmiTransDetailInfo():base("TT_WMM_VMI_TRANS_DETAIL")
		{
		...
		public VmiTransDetailInfo Clone()
		{
			return ((ICloneable) this).Clone() as VmiTransDetailInfo;	
		}
		#endregion
	...
	/// <summary>
    /// VmiTransDetailInfoCollection对应表[TT_WMM_VMI_TRANS_DETAIL]
    /// </summary>
	public partial class VmiTransDetailInfoCollection : BusinessObjectCollection<VmiTransDetailInfo>
	{
		public VmiTransDetailInfoCollection():base("TT_WMM_VMI_TRANS_DETAIL"){}	
	}
}
