...
//---------------------------------------------------------------------------
// Name:		Shgx003Info
// Function: 	Expose data in table Shgx003 from database as business object to MES system.
// Tool:		T4
...
{   
	/// <summary>
    /// Shgx003Info对应表[V_WMM_SHGX_003]
    /// </summary>	
	[Serializable] 
	[DataContract]	
    public partial class Shgx003Info : BusinessObject, ICloneable 
	{		  
		#region Constructors
		...
		public Shgx003Info():base("V_WMM_SHGX_003")
		{
		...
		public Shgx003Info Clone()
		{
			return ((ICloneable) this).Clone() as Shgx003Info;	
		}
		#endregion
	...
	/// <summary>
    /// Shgx003InfoCollection对应表[V_WMM_SHGX_003]
    /// </summary>
	public partial class Shgx003InfoCollection : BusinessObjectCollection<Shgx003Info>
	{
		public Shgx003InfoCollection():base("V_WMM_SHGX_003"){}	
	}
}
