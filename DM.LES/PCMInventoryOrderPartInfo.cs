#region Declaim
//---------------------------------------------------------------------------
// Name:		PCMInventoryOrderPartInfo
...
{
    /// <summary>
    /// PCMInventoryOrderPartInfo对应表[TT_PCM_INVENTORY_ORDER_PART]
    /// </summary>	
    [Serializable]
    [DataContract]
    public partial class PCMInventoryOrderPartInfo : BusinessObject, ICloneable
    {
        #region Constructors

        public PCMInventoryOrderPartInfo(
                    long aId,
        ...
        public PCMInventoryOrderPartInfo() : base("TT_PCM_INVENTORY_ORDER_PART")
        {
        ...
        public PCMInventoryOrderPartInfo Clone()
        {
            return ((ICloneable)this).Clone() as PCMInventoryOrderPartInfo;
        }
        #endregion
    ...
    /// <summary>
    /// PCMInventoryOrderPartInfoCollection对应表[TT_PCM_INVENTORY_ORDER_PART]
    /// </summary>
    public partial class PCMInventoryOrderPartInfoCollection : BusinessObjectCollection<PCMInventoryOrderPartInfo>
    {
        public PCMInventoryOrderPartInfoCollection() : base("TT_PCM_INVENTORY_ORDER_PART") { }
    }
}
