#region Declaim
//---------------------------------------------------------------------------
// Name:		MesOutboundDetailLogInfo
// Function: 	Expose data in table MesOutboundDetailLog from database as business object to MES system.
// Tool:		T4
...
{   
	/// <summary>
    /// MesOutboundDetailLogInfo对应表[TI_IFM_MES_OUTBOUND_DETAIL_LOG]
    /// </summary>	
	[Serializable] 
	[DataContract]	
    public partial class MesOutboundDetailLogInfo : BusinessObject, ICloneable 
	{		  
		#region Constructors
		
		public MesOutboundDetailLogInfo( 
					int aId,
		...
		public MesOutboundDetailLogInfo():base("TI_IFM_MES_OUTBOUND_DETAIL_LOG")
		{
		...
		public MesOutboundDetailLogInfo Clone()
		{
			return ((ICloneable) this).Clone() as MesOutboundDetailLogInfo;	
		}
		#endregion
	...
	/// <summary>
    /// MesOutboundDetailLogInfoCollection对应表[TI_IFM_MES_OUTBOUND_DETAIL_LOG]
    /// </summary>
	public partial class MesOutboundDetailLogInfoCollection : BusinessObjectCollection<MesOutboundDetailLogInfo>
	{
		public MesOutboundDetailLogInfoCollection():base("TI_IFM_MES_OUTBOUND_DETAIL_LOG"){}	
	}
}
