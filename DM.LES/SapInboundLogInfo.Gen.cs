#region Declaim
//---------------------------------------------------------------------------
// Name:		SapInboundLogInfo
// Function: 	Expose data in table SapInboundLog from database as business object to MES system.
// Tool:		T4
...
{   
	/// <summary>
    /// SapInboundLogInfo对应表[TI_IFM_SAP_INBOUND_LOG]
    /// </summary>	
	[Serializable] 
	[DataContract]	
    public partial class SapInboundLogInfo : BusinessObject, ICloneable 
	{		  
		#region Constructors
		
		public SapInboundLogInfo( 
					long aId,
		...
		public SapInboundLogInfo():base("TI_IFM_SAP_INBOUND_LOG")
		{
		...
		public SapInboundLogInfo Clone()
		{
			return ((ICloneable) this).Clone() as SapInboundLogInfo;	
		}
		#endregion
	...
	/// <summary>
    /// SapInboundLogInfoCollection对应表[TI_IFM_SAP_INBOUND_LOG]
    /// </summary>
	public partial class SapInboundLogInfoCollection : BusinessObjectCollection<SapInboundLogInfo>
	{
		public SapInboundLogInfoCollection():base("TI_IFM_SAP_INBOUND_LOG"){}	
	}
}
