#region Declaim
//---------------------------------------------------------------------------
// Name:		VmiOutboundDetailLogInfo
// Function: 	Expose data in table VmiOutboundDetailLog from database as business object to MES system.
// Tool:		T4
...
{   
	/// <summary>
    /// VmiOutboundDetailLogInfo对应表[TI_IFM_VMI_OUTBOUND_DETAIL_LOG]
    /// </summary>	
	[Serializable] 
	[DataContract]	
    public partial class VmiOutboundDetailLogInfo : BusinessObject, ICloneable 
	{		  
		#region Constructors
		
		public VmiOutboundDetailLogInfo( 
					int aId,
		...
		public VmiOutboundDetailLogInfo():base("TI_IFM_VMI_OUTBOUND_DETAIL_LOG")
		{
		...
		public VmiOutboundDetailLogInfo Clone()
		{
			return ((ICloneable) this).Clone() as VmiOutboundDetailLogInfo;	
		}
		#endregion
	...
	/// <summary>
    /// VmiOutboundDetailLogInfoCollection对应表[TI_IFM_VMI_OUTBOUND_DETAIL_LOG]
    /// </summary>
	public partial class VmiOutboundDetailLogInfoCollection : BusinessObjectCollection<VmiOutboundDetailLogInfo>
	{
		public VmiOutboundDetailLogInfoCollection():base("TI_IFM_VMI_OUTBOUND_DETAIL_LOG"){}	
	}
}
