#region Declaim
//---------------------------------------------------------------------------
// Name:		VmiPullOrderDetailInfo
// Function: 	Expose data in table VmiPullOrderDetail from database as business object to MES system.
// Tool:		T4
...
{   
	/// <summary>
    /// VmiPullOrderDetailInfo对应表[TT_MPM_VMI_PULL_ORDER_DETAIL]
    /// </summary>	
	[Serializable] 
	[DataContract]	
    public partial class VmiPullOrderDetailInfo : BusinessObject, ICloneable 
	{		  
		#region Constructors
		
		public VmiPullOrderDetailInfo( 
					long aId,
		...
		public VmiPullOrderDetailInfo():base("TT_MPM_VMI_PULL_ORDER_DETAIL")
		{
		...
		public VmiPullOrderDetailInfo Clone()
		{
			return ((ICloneable) this).Clone() as VmiPullOrderDetailInfo;	
		}
		#endregion
	...
	/// <summary>
    /// VmiPullOrderDetailInfoCollection对应表[TT_MPM_VMI_PULL_ORDER_DETAIL]
    /// </summary>
	public partial class VmiPullOrderDetailInfoCollection : BusinessObjectCollection<VmiPullOrderDetailInfo>
	{
		public VmiPullOrderDetailInfoCollection():base("TT_MPM_VMI_PULL_ORDER_DETAIL"){}	
	}
}
