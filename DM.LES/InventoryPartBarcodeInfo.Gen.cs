#region Declaim
//---------------------------------------------------------------------------
// Name:		InventoryPartBarcodeInfo
// Function: 	Expose data in table InventoryPartBarcode from database as business object to MES system.
// Tool:		T4
...
{   
	/// <summary>
    /// InventoryPartBarcodeInfo对应表[TT_WMM_INVENTORY_PART_BARCODE]
    /// </summary>	
	[Serializable] 
	[DataContract]	
    public partial class InventoryPartBarcodeInfo : BusinessObject, ICloneable 
	{		  
		#region Constructors
		
		public InventoryPartBarcodeInfo( 
					long aId,
		...
		public InventoryPartBarcodeInfo():base("TT_WMM_INVENTORY_PART_BARCODE")
		{
			...
			DataSchemaField PART_FIDField = new DataSchemaField();
			PART_FIDField.Name = "PART_FID";
			PART_FIDField.Type = typeof(Guid).ToString();
			PART_FIDField.Index = 2;
			fields.Add(PART_FIDField);
			...
			DataSchemaField PER_PART_QTYField = new DataSchemaField();
			PER_PART_QTYField.Name = "PER_PART_QTY";
			PER_PART_QTYField.Type = typeof(decimal).ToString();
			PER_PART_QTYField.Index = 11;
			fields.Add(PER_PART_QTYField);
			 
			DataSchemaField PART_QTYField = new DataSchemaField();
			PART_QTYField.Name = "PART_QTY";
			PART_QTYField.Type = typeof(decimal).ToString();
			PART_QTYField.Index = 12;
		...
		object ICloneable.Clone()
		{
			...
			info.PerPartQty = this.PerPartQty;
		...
		public InventoryPartBarcodeInfo Clone()
		{
			return ((ICloneable) this).Clone() as InventoryPartBarcodeInfo;	
		}
		#endregion
	...
	/// <summary>
    /// InventoryPartBarcodeInfoCollection对应表[TT_WMM_INVENTORY_PART_BARCODE]
    /// </summary>
	public partial class InventoryPartBarcodeInfoCollection : BusinessObjectCollection<InventoryPartBarcodeInfo>
	{
		public InventoryPartBarcodeInfoCollection():base("TT_WMM_INVENTORY_PART_BARCODE"){}	
	}
}
