#region Declaim
//---------------------------------------------------------------------------
// Name:		MesProductionOrderLackMaterialInfo
// Function: 	Expose data in table MesProductionOrderLackMaterial from database as business object to MES system.
// Tool:		T4
...
{   
	/// <summary>
    /// MesProductionOrderLackMaterialInfo对应表[TI_IFM_MES_PRODUCTION_ORDER_LACK_MATERIAL]
    /// </summary>	
	[Serializable] 
	[DataContract]	
    public partial class MesProductionOrderLackMaterialInfo : BusinessObject, ICloneable 
	{		  
		#region Constructors
		
		public MesProductionOrderLackMaterialInfo( 
					int aId,
		...
		public MesProductionOrderLackMaterialInfo():base("TI_IFM_MES_PRODUCTION_ORDER_LACK_MATERIAL")
		{
		...
		public MesProductionOrderLackMaterialInfo Clone()
		{
			return ((ICloneable) this).Clone() as MesProductionOrderLackMaterialInfo;	
		}
		#endregion
	...
	/// <summary>
    /// MesProductionOrderLackMaterialInfoCollection对应表[TI_IFM_MES_PRODUCTION_ORDER_LACK_MATERIAL]
    /// </summary>
	public partial class MesProductionOrderLackMaterialInfoCollection : BusinessObjectCollection<MesProductionOrderLackMaterialInfo>
	{
		public MesProductionOrderLackMaterialInfoCollection():base("TI_IFM_MES_PRODUCTION_ORDER_LACK_MATERIAL"){}	
	}
}
