#region Declaim
//---------------------------------------------------------------------------
// Name:		QmisInboundLogInfo
// Function: 	Expose data in table QmisInboundLog from database as business object to MES system.
// Tool:		T4
...
{   
	/// <summary>
    /// QmisInboundLogInfo对应表[TI_IFM_QMIS_INBOUND_LOG]
    /// </summary>	
	[Serializable] 
	[DataContract]	
    public partial class QmisInboundLogInfo : BusinessObject, ICloneable 
	{		  
		#region Constructors
		
		public QmisInboundLogInfo( 
					long aId,
		...
		public QmisInboundLogInfo():base("TI_IFM_QMIS_INBOUND_LOG")
		{
		...
		public QmisInboundLogInfo Clone()
		{
			return ((ICloneable) this).Clone() as QmisInboundLogInfo;	
		}
		#endregion
	...
	/// <summary>
    /// QmisInboundLogInfoCollection对应表[TI_IFM_QMIS_INBOUND_LOG]
    /// </summary>
	public partial class QmisInboundLogInfoCollection : BusinessObjectCollection<QmisInboundLogInfo>
	{
		public QmisInboundLogInfoCollection():base("TI_IFM_QMIS_INBOUND_LOG"){}	
	}
}
