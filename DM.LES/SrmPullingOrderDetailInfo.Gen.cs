#region Declaim
//---------------------------------------------------------------------------
// Name:		SrmPullingOrderDetailInfo
// Function: 	Expose data in table SrmPullingOrderDetail from database as business object to MES system.
// Tool:		T4
...
{   
	/// <summary>
    /// SrmPullingOrderDetailInfo对应表[TI_IFM_SRM_PULLING_ORDER_DETAIL]
    /// </summary>	
	[Serializable] 
	[DataContract]	
    public partial class SrmPullingOrderDetailInfo : BusinessObject, ICloneable 
	{		  
		#region Constructors
		
		public SrmPullingOrderDetailInfo( 
					long aId,
		...
		public SrmPullingOrderDetailInfo():base("TI_IFM_SRM_PULLING_ORDER_DETAIL")
		{
		...
		public SrmPullingOrderDetailInfo Clone()
		{
			return ((ICloneable) this).Clone() as SrmPullingOrderDetailInfo;	
		}
		#endregion
	...
	/// <summary>
    /// SrmPullingOrderDetailInfoCollection对应表[TI_IFM_SRM_PULLING_ORDER_DETAIL]
    /// </summary>
	public partial class SrmPullingOrderDetailInfoCollection : BusinessObjectCollection<SrmPullingOrderDetailInfo>
	{
		public SrmPullingOrderDetailInfoCollection():base("TI_IFM_SRM_PULLING_ORDER_DETAIL"){}	
	}
}
