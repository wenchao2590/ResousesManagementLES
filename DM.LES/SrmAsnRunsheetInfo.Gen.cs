#region Declaim
//---------------------------------------------------------------------------
// Name:		SrmAsnRunsheetInfo
// Function: 	Expose data in table SrmAsnRunsheet from database as business object to MES system.
// Tool:		T4
...
{   
	/// <summary>
    /// SrmAsnRunsheetInfo对应表[TI_IFM_SRM_ASN_RUNSHEET]
    /// </summary>	
	[Serializable] 
	[DataContract]	
    public partial class SrmAsnRunsheetInfo : BusinessObject, ICloneable 
	{		  
		#region Constructors
		
		public SrmAsnRunsheetInfo( 
					long aId,
		...
		public SrmAsnRunsheetInfo():base("TI_IFM_SRM_ASN_RUNSHEET")
		{
		...
		public SrmAsnRunsheetInfo Clone()
		{
			return ((ICloneable) this).Clone() as SrmAsnRunsheetInfo;	
		}
		#endregion
	...
	/// <summary>
    /// SrmAsnRunsheetInfoCollection对应表[TI_IFM_SRM_ASN_RUNSHEET]
    /// </summary>
	public partial class SrmAsnRunsheetInfoCollection : BusinessObjectCollection<SrmAsnRunsheetInfo>
	{
		public SrmAsnRunsheetInfoCollection():base("TI_IFM_SRM_ASN_RUNSHEET"){}	
	}
}
