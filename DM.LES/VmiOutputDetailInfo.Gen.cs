#region Declaim
//---------------------------------------------------------------------------
// Name:		VmiOutputDetailInfo
// Function: 	Expose data in table VmiOutputDetail from database as business object to MES system.
// Tool:		T4
...
{   
	/// <summary>
    /// VmiOutputDetailInfo对应表[TT_WMM_VMI_OUTPUT_DETAIL]
    /// </summary>	
	[Serializable] 
	[DataContract]	
    public partial class VmiOutputDetailInfo : BusinessObject, ICloneable 
	{		  
		#region Constructors
		
		public VmiOutputDetailInfo( 
					long aId,
		...
		public VmiOutputDetailInfo():base("TT_WMM_VMI_OUTPUT_DETAIL")
		{
		...
		public VmiOutputDetailInfo Clone()
		{
			return ((ICloneable) this).Clone() as VmiOutputDetailInfo;	
		}
		#endregion
	...
	/// <summary>
    /// VmiOutputDetailInfoCollection对应表[TT_WMM_VMI_OUTPUT_DETAIL]
    /// </summary>
	public partial class VmiOutputDetailInfoCollection : BusinessObjectCollection<VmiOutputDetailInfo>
	{
		public VmiOutputDetailInfoCollection():base("TT_WMM_VMI_OUTPUT_DETAIL"){}	
	}
}
