...
//---------------------------------------------------------------------------
// Name:		Shgx004Info
// Function: 	Expose data in table Shgx004 from database as business object to MES system.
// Tool:		T4
...
{   
	/// <summary>
    /// Shgx004Info对应表[V_WMM_SHGX_004]
    /// </summary>	
	[Serializable] 
	[DataContract]	
    public partial class Shgx004Info : BusinessObject, ICloneable 
	{		  
		#region Constructors
		...
		public Shgx004Info():base("V_WMM_SHGX_004")
		{
		...
		public Shgx004Info Clone()
		{
			return ((ICloneable) this).Clone() as Shgx004Info;	
		}
		#endregion
	...
	/// <summary>
    /// Shgx004InfoCollection对应表[V_WMM_SHGX_004]
    /// </summary>
	public partial class Shgx004InfoCollection : BusinessObjectCollection<Shgx004Info>
	{
		public Shgx004InfoCollection():base("V_WMM_SHGX_004"){}	
	}
}
