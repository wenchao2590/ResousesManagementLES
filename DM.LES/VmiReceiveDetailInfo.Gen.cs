#region Declaim
//---------------------------------------------------------------------------
// Name:		VmiReceiveDetailInfo
// Function: 	Expose data in table VmiReceiveDetail from database as business object to MES system.
// Tool:		T4
...
{   
	/// <summary>
    /// VmiReceiveDetailInfo对应表[TT_WMM_VMI_RECEIVE_DETAIL]
    /// </summary>	
	[Serializable] 
	[DataContract]	
    public partial class VmiReceiveDetailInfo : BusinessObject, ICloneable 
	{		  
		#region Constructors
		
		public VmiReceiveDetailInfo( 
					long aId,
		...
		public VmiReceiveDetailInfo():base("TT_WMM_VMI_RECEIVE_DETAIL")
		{
		...
		public VmiReceiveDetailInfo Clone()
		{
			return ((ICloneable) this).Clone() as VmiReceiveDetailInfo;	
		}
		#endregion
	...
	/// <summary>
    /// VmiReceiveDetailInfoCollection对应表[TT_WMM_VMI_RECEIVE_DETAIL]
    /// </summary>
	public partial class VmiReceiveDetailInfoCollection : BusinessObjectCollection<VmiReceiveDetailInfo>
	{
		public VmiReceiveDetailInfoCollection():base("TT_WMM_VMI_RECEIVE_DETAIL"){}	
	}
}
