#region Declaim
//---------------------------------------------------------------------------
// Name:		WmsInboundDataInfo
// Function: 	Expose data in table WmsInboundData from database as business object to MES system.
// Tool:		T4
...
{   
	/// <summary>
    /// WmsInboundDataInfo对应表[TI_IFM_WMS_INBOUND_DATA]
    /// </summary>	
	[Serializable] 
	[DataContract]	
    public partial class WmsInboundDataInfo : BusinessObject, ICloneable 
	{		  
		#region Constructors
		
		public WmsInboundDataInfo( 
					long aId,
		...
		public WmsInboundDataInfo():base("TI_IFM_WMS_INBOUND_DATA")
		{
		...
		public WmsInboundDataInfo Clone()
		{
			return ((ICloneable) this).Clone() as WmsInboundDataInfo;	
		}
		#endregion
	...
	/// <summary>
    /// WmsInboundDataInfoCollection对应表[TI_IFM_WMS_INBOUND_DATA]
    /// </summary>
	public partial class WmsInboundDataInfoCollection : BusinessObjectCollection<WmsInboundDataInfo>
	{
		public WmsInboundDataInfoCollection():base("TI_IFM_WMS_INBOUND_DATA"){}	
	}
}
