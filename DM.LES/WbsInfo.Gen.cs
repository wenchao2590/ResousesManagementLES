...
//---------------------------------------------------------------------------
// Name:		WbsInfo
// Function: 	Expose data in table Wbs from database as business object to MES system.
// Tool:		T4
...
{   
	/// <summary>
    /// WbsInfo对应表[TM_BAS_WBS]
    /// </summary>	
	[Serializable] 
	[DataContract]	
    public partial class WbsInfo : BusinessObject, ICloneable 
	{		  
		#region Constructors
		...
		public WbsInfo():base("TM_BAS_WBS")
		{
			List<string> keys = new List<string>();
			 			keys.Add("WBS_ID");           _Keys = keys.ToArray();
			
			Schema = new DataSchema();
			List<DataSchemaField> fields = new List<DataSchemaField>();
			
			 
			DataSchemaField WBS_IDField = new DataSchemaField();
			WBS_IDField.Name = "WBS_ID";
			WBS_IDField.Type = typeof(long).ToString();
			WBS_IDField.Index = 0;
			fields.Add(WBS_IDField);
			...
			WBS_CODEField.Index = 5;
			fields.Add(WBS_CODEField);
			 
			DataSchemaField WBS_NAMEField = new DataSchemaField();
			WBS_NAMEField.Name = "WBS_NAME";
			WBS_NAMEField.Type = typeof(string).ToString();
			WBS_NAMEField.Index = 6;
			fields.Add(WBS_NAMEField);
		...
		public WbsInfo Clone()
		{
			return ((ICloneable) this).Clone() as WbsInfo;	
		}
		#endregion
	...
	/// <summary>
    /// WbsInfoCollection对应表[TM_BAS_WBS]
    /// </summary>
	public partial class WbsInfoCollection : BusinessObjectCollection<WbsInfo>
	{
		public WbsInfoCollection():base("TM_BAS_WBS"){}	
	}
}
