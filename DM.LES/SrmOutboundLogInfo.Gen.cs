#region Declaim
//---------------------------------------------------------------------------
// Name:		SrmOutboundLogInfo
// Function: 	Expose data in table SrmOutboundLog from database as business object to MES system.
// Tool:		T4
...
{   
	/// <summary>
    /// SrmOutboundLogInfo对应表[TI_IFM_SRM_OUTBOUND_LOG]
    /// </summary>	
	[Serializable] 
	[DataContract]	
    public partial class SrmOutboundLogInfo : BusinessObject, ICloneable 
	{		  
		#region Constructors
		
		public SrmOutboundLogInfo( 
					long aId,
		...
		public SrmOutboundLogInfo():base("TI_IFM_SRM_OUTBOUND_LOG")
		{
		...
		public SrmOutboundLogInfo Clone()
		{
			return ((ICloneable) this).Clone() as SrmOutboundLogInfo;	
		}
		#endregion
	...
	/// <summary>
    /// SrmOutboundLogInfoCollection对应表[TI_IFM_SRM_OUTBOUND_LOG]
    /// </summary>
	public partial class SrmOutboundLogInfoCollection : BusinessObjectCollection<SrmOutboundLogInfo>
	{
		public SrmOutboundLogInfoCollection():base("TI_IFM_SRM_OUTBOUND_LOG"){}	
	}
}
