#region Declaim
//---------------------------------------------------------------------------
// Name:		VmiShippingPartInfo
// Function: 	Expose data in table VmiShippingPart from database as business object to MES system.
// Tool:		T4
...
{   
	/// <summary>
    /// VmiShippingPartInfo对应表[TE_MPM_VMI_SHIPPING_PART]
    /// </summary>	
	[Serializable] 
	[DataContract]	
    public partial class VmiShippingPartInfo : BusinessObject, ICloneable 
	{		  
		#region Constructors
		
		public VmiShippingPartInfo( 
					long aId,
		...
		public VmiShippingPartInfo():base("TE_MPM_VMI_SHIPPING_PART")
		{
		...
		public VmiShippingPartInfo Clone()
		{
			return ((ICloneable) this).Clone() as VmiShippingPartInfo;	
		}
		#endregion
	...
	/// <summary>
    /// VmiShippingPartInfoCollection对应表[TE_MPM_VMI_SHIPPING_PART]
    /// </summary>
	public partial class VmiShippingPartInfoCollection : BusinessObjectCollection<VmiShippingPartInfo>
	{
		public VmiShippingPartInfoCollection():base("TE_MPM_VMI_SHIPPING_PART"){}	
	}
}
