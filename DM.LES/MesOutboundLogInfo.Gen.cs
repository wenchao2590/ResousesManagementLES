#region Declaim
//---------------------------------------------------------------------------
// Name:		MesOutboundLogInfo
// Function: 	Expose data in table MesOutboundLog from database as business object to MES system.
// Tool:		T4
...
{   
	/// <summary>
    /// MesOutboundLogInfo对应表[TI_IFM_MES_OUTBOUND_LOG]
    /// </summary>	
	[Serializable] 
	[DataContract]	
    public partial class MesOutboundLogInfo : BusinessObject, ICloneable 
	{		  
		#region Constructors
		
		public MesOutboundLogInfo( 
					long aId,
		...
		public MesOutboundLogInfo():base("TI_IFM_MES_OUTBOUND_LOG")
		{
		...
		public MesOutboundLogInfo Clone()
		{
			return ((ICloneable) this).Clone() as MesOutboundLogInfo;	
		}
		#endregion
	...
	/// <summary>
    /// MesOutboundLogInfoCollection对应表[TI_IFM_MES_OUTBOUND_LOG]
    /// </summary>
	public partial class MesOutboundLogInfoCollection : BusinessObjectCollection<MesOutboundLogInfo>
	{
		public MesOutboundLogInfoCollection():base("TI_IFM_MES_OUTBOUND_LOG"){}	
	}
}
