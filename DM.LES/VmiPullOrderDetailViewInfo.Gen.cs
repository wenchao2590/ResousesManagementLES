#region Declaim
//---------------------------------------------------------------------------
// Name:		VmiPullOrderDetailViewInfo
// Function: 	Expose data in table VmiPullOrderDetailView from database as business object to MES system.
// Tool:		T4
...
{   
	/// <summary>
    /// VmiPullOrderDetailViewInfo对应表[V_MPM_VMI_PULL_ORDER_DETAIL_VIEW]
    /// </summary>	
	[Serializable] 
	[DataContract]	
    public partial class VmiPullOrderDetailViewInfo : BusinessObject, ICloneable 
	{		  
		#region Constructors
		
		public VmiPullOrderDetailViewInfo( 
					long aId,
		...
		public VmiPullOrderDetailViewInfo():base("V_MPM_VMI_PULL_ORDER_DETAIL_VIEW")
		{
		...
		public VmiPullOrderDetailViewInfo Clone()
		{
			return ((ICloneable) this).Clone() as VmiPullOrderDetailViewInfo;	
		}
		#endregion
	...
	/// <summary>
    /// VmiPullOrderDetailViewInfoCollection对应表[V_MPM_VMI_PULL_ORDER_DETAIL_VIEW]
    /// </summary>
	public partial class VmiPullOrderDetailViewInfoCollection : BusinessObjectCollection<VmiPullOrderDetailViewInfo>
	{
		public VmiPullOrderDetailViewInfoCollection():base("V_MPM_VMI_PULL_ORDER_DETAIL_VIEW"){}	
	}
}
