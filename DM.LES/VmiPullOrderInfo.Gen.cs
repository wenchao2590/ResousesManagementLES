#region Declaim
//---------------------------------------------------------------------------
// Name:		VmiPullOrderInfo
// Function: 	Expose data in table VmiPullOrder from database as business object to MES system.
// Tool:		T4
...
{   
	/// <summary>
    /// VmiPullOrderInfo对应表[TT_MPM_VMI_PULL_ORDER]
    /// </summary>	
	[Serializable] 
	[DataContract]	
    public partial class VmiPullOrderInfo : BusinessObject, ICloneable 
	{		  
		#region Constructors
		
		public VmiPullOrderInfo( 
					long aId,
		...
		public VmiPullOrderInfo():base("TT_MPM_VMI_PULL_ORDER")
		{
			...
			PLAN_SHIPPING_TIMEField.Index = 17;
			...
			PLAN_DELIVERY_TIMEField.Index = 18;
			...
			ACTUAL_UNLOADING_TIMEField.Index = 20;
			...
			ASN_FLAGField.Index = 25;
			fields.Add(ASN_FLAGField);
			 
			DataSchemaField TIME_ZONESField = new DataSchemaField();
			TIME_ZONESField.Name = "TIME_ZONES";
			TIME_ZONESField.Type = typeof(string).ToString();
			TIME_ZONESField.Index = 26;
			fields.Add(TIME_ZONESField);
		...
		public VmiPullOrderInfo Clone()
		{
			return ((ICloneable) this).Clone() as VmiPullOrderInfo;	
		}
		#endregion
	...
	/// <summary>
    /// VmiPullOrderInfoCollection对应表[TT_MPM_VMI_PULL_ORDER]
    /// </summary>
	public partial class VmiPullOrderInfoCollection : BusinessObjectCollection<VmiPullOrderInfo>
	{
		public VmiPullOrderInfoCollection():base("TT_MPM_VMI_PULL_ORDER"){}	
	}
}
