#region Declaim
//---------------------------------------------------------------------------
// Name:		VmiDeliveryNoteDetailInfo
// Function: 	Expose data in table VmiDeliveryNoteDetail from database as business object to MES system.
// Tool:		T4
...
{   
	/// <summary>
    /// VmiDeliveryNoteDetailInfo对应表[IFM_SRM_VMI_DELIVERY_NOTE_DETAIL]
    /// </summary>	
	[Serializable] 
	[DataContract]	
    public partial class VmiDeliveryNoteDetailInfo : BusinessObject, ICloneable 
	{		  
		#region Constructors
		
		public VmiDeliveryNoteDetailInfo( 
					long aId,
		...
		public VmiDeliveryNoteDetailInfo():base("IFM_SRM_VMI_DELIVERY_NOTE_DETAIL")
		{
		...
		{
			VmiDeliveryNoteDetailInfo info = new VmiDeliveryNoteDetailInfo();
		...
		public VmiDeliveryNoteDetailInfo Clone()
		{
			return ((ICloneable) this).Clone() as VmiDeliveryNoteDetailInfo;	
		}
		#endregion
	...
	/// <summary>
    /// VmiDeliveryNoteDetailInfoCollection对应表[IFM_SRM_VMI_DELIVERY_NOTE_DETAIL]
    /// </summary>
	public partial class VmiDeliveryNoteDetailInfoCollection : BusinessObjectCollection<VmiDeliveryNoteDetailInfo>
	{
		public VmiDeliveryNoteDetailInfoCollection():base("IFM_SRM_VMI_DELIVERY_NOTE_DETAIL"){}	
	}
}
