#region Declaim
//---------------------------------------------------------------------------
// Name:		SrmDeliveryNoteInfo
// Function: 	Expose data in table SrmDeliveryNote from database as business object to MES system.
// Tool:		T4
...
{   
	/// <summary>
    /// SrmDeliveryNoteInfo对应表[TI_IFM_SRM_DELIVERY_NOTE]
    /// </summary>	
	[Serializable] 
	[DataContract]	
    public partial class SrmDeliveryNoteInfo : BusinessObject, ICloneable 
	{		  
		#region Constructors
		
		public SrmDeliveryNoteInfo( 
					long aId,
		...
		public SrmDeliveryNoteInfo():base("TI_IFM_SRM_DELIVERY_NOTE")
		{
		...
		public SrmDeliveryNoteInfo Clone()
		{
			return ((ICloneable) this).Clone() as SrmDeliveryNoteInfo;	
		}
		#endregion
	...
	/// <summary>
    /// SrmDeliveryNoteInfoCollection对应表[TI_IFM_SRM_DELIVERY_NOTE]
    /// </summary>
	public partial class SrmDeliveryNoteInfoCollection : BusinessObjectCollection<SrmDeliveryNoteInfo>
	{
		public SrmDeliveryNoteInfoCollection():base("TI_IFM_SRM_DELIVERY_NOTE"){}	
	}
}
