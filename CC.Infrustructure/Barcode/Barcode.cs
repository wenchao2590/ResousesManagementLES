...
namespace Infrustructure.Barcode
{
    ...
    /// 条码类型
    /// </summary>
    public enum BarcodeType : int { UNSPECIFIED, UPCA, UPCE, UPC_SUPPLEMENTAL_2DIGIT, UPC_SUPPLEMENTAL_5DIGIT, EAN13, EAN8, Interleaved2of5, Standard2of5, Industrial2of5, CODE39, CODE39Extended, Codabar, PostNet, BOOKLAND, ISBN, JAN13, MSI_Mod10, MSI_2Mod10, MSI_Mod11, MSI_Mod11_Mod10, Modified_Plessey, CODE11, USD8, UCC12, UCC13, LOGMARS, CODE128, CODE128A, CODE128B, CODE128C, ITF14, CODE93, TELEPEN };
    /// <summary>
    /// 生成格式
    /// </summary>
    ...
    public class Barcode : IDisposable
    {
        ...
        /// </summary>
        /// <param name="iType">Type of encoding to use.</param>
        internal Image Encode(BarcodeType iType)
        {
            Encoded_Type = iType;
            return Encode();
        }//Encode()
        ...
        {
            if (Encoded_Value == "") throw new System.Exception("EGENERATE_IMAGE-1: Must be encoded first.");
            Bitmap b = null;
                ...
                case BarcodeType.ITF14:
                    {
                        ...
                        if (iBarWidth <= 0 || iquietzone <= 0)
                            throw new System.Exception("EGENERATE_IMAGE-3: Image size specified not large enough to draw image. (Bar size determined to be less than 1 pixel or quiet zone determined to be less than 1 pixel)");
                ...
                default:
                    {
                        ...
                        if (this.Encoded_Type == BarcodeType.PostNet)
                            iBarWidthModifier = 2;
                        ...
                        if (iBarWidth <= 0)
                            throw new System.Exception("EGENERATE_IMAGE-2: Image size specified not large enough to draw image. (Bar size determined to be less than 1 pixel)");
        ...
        public void SaveImage(string Filename, SaveTypes FileType)
        {
            ...
            {
                throw new System.Exception("ESAVEIMAGE-1: Could not save image.\n\n=======================\n\n" + ex.Message);
            }//catch
        ...
        private Image Label_ITF14(Image img)
        {
            ...
            {
                throw new System.Exception("ELABEL_ITF14-1: " + ex.Message);
            }//catch
        }
        /// <summary>
        /// Draws Label for Generic
        /// </summary>
        /// <param name="img"></param>
        /// <returns></returns>
        private Image Label_Generic(Image img)
        {
            ...
            {
                throw new System.Exception("ELABEL_GENERIC-1: " + ex.Message);
            }//catch
        }//Label_Generic
        ...
        private Image Label_UPCA(Image img)
        {
            ...
            {
                throw new System.Exception("ELABEL_UPCA-1: " + ex.Message);
            }//catch
        }//Label_UPCA
        #endregion
        #endregion
        ...
        #region Misc
        /// <summary>
        /// This will verify that only numeric data is contained in the string passed in.
        /// </summary>
        ...
        public void Dispose()
        {
            ...
            {
                throw new System.Exception("EDISPOSE-1: " + ex.Message);
            }
        }
