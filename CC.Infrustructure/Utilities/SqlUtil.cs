...
namespace Infrustructure.Utilities
{
    public static class DBConvert
    {
        ...
        /// <param name="i">dataReader中的列索引</param>
        /// <returns></returns>
        public static Byte GetImage(System.Data.IDataReader dataReader, int i)
        {
            if (dataReader.IsDBNull(i))
            {
        ...
        /// <param name="i">dataReader中的列索引</param>
        /// <returns></returns>
        public static long? GetInt64Nullable(System.Data.IDataReader dataReader, int i)
        {
            if (dataReader.IsDBNull(i))
            {
                return null;
        ...
        /// <param name="i">dataReader中的列索引</param>
        /// <returns></returns>
        public static long GetInt64(System.Data.IDataReader dataReader, int i)
        {
            if (dataReader.IsDBNull(i))
            {
                return int.MinValue;
        ...
        public static byte[] GetBytes(System.Data.IDataReader dataReader, int i)
        {
            if (dataReader.IsDBNull(i))
                return null;
            return (byte[])dataReader[i];
        }
    }
        ...
        public static string ToString(object obj)
        {
            ...
            else
            {
                ...
                if (!Regex.IsMatch(resultStr, regNormalString))
                    throw new MPSBusinessException(string.Format("Excel中数据[" + resultStr + "]存在非法字符,请确认。"));
            }
            return resultStr;
        }
